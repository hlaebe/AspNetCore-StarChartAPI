...
namespace StarChart.Controllers
{
    ...
    public class CelestialObjectController : ControllerBase
    {
        ...
        {
            var existsingObjects = _context.CelestialObjects.Where (e => e.Id == id || e.OrbitedObjectId == id);
            if (!existsingObjects.Any())
                return NotFound();
            _context.CelestialObjects.RemoveRange(existsingObjects);
            _context.SaveChanges();
            return NoContent();
        }
    }
